...
router.post('/', auditLogMiddleware('USER_CREATED', AuditEntityType.USER), usersController.create);
router.get('/:id', usersController.getById);
router.put('/:id', auditLogMiddleware('USER_UPDATED', AuditEntityType.USER), usersController.update);
